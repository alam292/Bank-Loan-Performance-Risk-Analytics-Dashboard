...
[![MySQL](https://img.shields.io/badge/MySQL-SQL%20Queries-4479A1?style=for-the-badge&logo=mysql&logoColor=white)](https://mysql.com)
...
![Dataset](https://img.shields.io/badge/Dataset-563%2B%20Records-FF6B6B?style=flat-square&logo=databricks&logoColor=white)
...
![Domain](https://img.shields.io/badge/Domain-Finance%20%26%20Credit%20Analytics-E91E63?style=flat-square&logo=databricks&logoColor=white)
...
| ![MySQL](https://img.shields.io/badge/-MySQL-4479A1?logo=mysql&logoColor=white&style=flat-square) | **MySQL** | 25 structured SQL queries across 7 sections |
...
| ![Power BI](https://img.shields.io/badge/-Power%20BI-F2C811?logo=powerbi&logoColor=black&style=flat-square) | **Power BI Desktop** | 6-page business intelligence dashboard |
...
flowchart TD
    ...
    B --> C[🧹 Data Cleaning\nDrop Duplicates · Handle Nulls · Drop Unknown Columns]
    C --> D[🔄 Data Transformation\nCategorical Encoding · Income_Group Feature Engineering]
    D --> E[🗄️ SQL Analysis\n25 Queries · 7 Sections · Business Insights]
    E --> F[📊 Exploratory Data Analysis\nApproval Rates · Credit Risk · Income Segmentation]
    F --> G[📈 Data Visualization\nBar Charts · Pie Charts · Heatmaps · Box Plots]
    G --> H[💡 Insight Extraction\nRisk Factor Ranking · Approval Pattern Recognition]
    H --> I[🖥️ Power BI Dashboard\n6 Pages · KPI Cards · Interactive Filters]
    I --> J[📤 Clean Data Export\nloan_approved_clean_data.csv]
...
[![Star](https://img.shields.io/github/stars/alam292/Loan-Approval-Risk-Analysis?style=social)](https://github.com/alam292/Loan-Approval-Risk-Analysis)
[![Fork](https://img.shields.io/github/forks/alam292/Loan-Approval-Risk-Analysis?style=social)](https://github.com/alam292/Loan-Approval-Risk-Analysis/fork)
